(function () {
    ...
    drawer.$inject = ['$window', '$rootScope'];

    function drawer($window, $rootScope) {
        var isInit = false;
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                scope.$watch(function(){return attrs.drawer}, function() {
                    if (attrs.drawer != 'none') {
                        ...
                        element.removeClass('ng-drawer');
                        element.removeClass('ng-drawer-left');
                        element.removeClass('ng-drawer-right');
